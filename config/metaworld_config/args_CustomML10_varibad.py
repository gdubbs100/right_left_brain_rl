...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', default='CustomML10-v2', help='environment to train on')
    ...
    # varibad appears to use smaller latents
    ...
    parser.add_argument('--policy_latent_embedding_dim', type=int, default=128)
    ...
    parser.add_argument('--lr_policy', type=float, default=7e-4, help='learning rate (default: 5e-4)')
