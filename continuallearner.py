...
class ContinualLearner:
    """
    Continual learning class
    """
    def __init__(self, seed, envs, max_rollouts_per_task):
        ...
        self.args.max_trajectory_len *= max_rollouts_per_task
        ...
        # initialise agent, storage and networks
        self.policy_storage = CustomOnlineStorage(

        )
        self.actor_critic = None
        self.policy = CustomPPO(
